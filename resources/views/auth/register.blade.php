        ...
        <div id="main-wrapper" class="auth-customizer-none">
            <div class="position-relative overflow-hidden radial-gradient min-vh-100 w-100">
                <div class="position-relative z-index-5">
                    <div class="row">
                        <div class="col-xl-7 col-xxl-7" style="background-image: url('../assets/images/frontend-pages/bg-sejarah2.jpg'); background-repeat: no-repeat; background-size: cover; background-position: left;">
                        ...
                        <div class="col-xl-5 col-xxl-5">
                            <div
                                class="min-vh-100 bg-body row justify-content-center align-items-center p-4">
                                <div class="col-sm-8 col-md-6 col-xl-7">
                                    ...
                                    enctype="multipart/form-data">
                                        ...
                                        <div id="form-container">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="NIP" type="text" name="NIP" value="{{ old('NIP') }}"
                                                                autofocus autocomplete="NIP" class="form-control">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="f_agama" type="text" name="f_agama"
                                                                value="{{ old('f_agama') }}" autofocus autocomplete="f_agama">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" id="f_no_wa" type="text" name="f_no_wa"
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="jabatan" type="text" name="jabatan"
                                                                value="{{ old('jabatan') }}" autofocus autocomplete="jabatan">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="instansi" type="text" name="instansi"
                                                                value="{{ old('instansi') }}" autofocus autocomplete="instansi">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="golongan" type="text" name="golongan"
                                                ...
                                                <div class="row">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="keahlian" type="text" name="keahlian"
                                                            value="{{ old('keahlian') }}" autofocus autocomplete="keahlian"
                                                            class="form-control">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="f_pendidikan_terakhir" name="f_pendidikan_terakhir"
                                                            class="form-control" value="{{ old('f_pendidikan_terakhir') }}"
                                                            autofocus autocomplete="f_pendidikan_terakhir" class="form-control">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="f_universitas" type="text"
                                                            name="f_universitas" value="{{ old('f_universitas') }}" autofocus
                                                            autocomplete="f_universitas">
                                            ...
                                            <div class="d-none">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select id="provinsi" type="text" name="provinsi"
                                                                value="{{ old('provinsi') }}" autofocus class="form-control">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="f_alamat" type="text" name="f_alamat"
                                                        value="{{ old('f_alamat') }}" autofocus autocomplete="f_alamat">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="f_bukti_pembayaran" class="form-label">Bukti
                                                                Pembayaran</label>
                                                            <input id="f_bukti_pembayaran" type="file" name="f_bukti_pembayaran"
                                                                autofocus autocomplete="f_bukti_pembayaran" class="form-control">
                                                        </div>
                                        ...
                                        <div class="d-absoluet button-0 mt-2">
                                            ...
                                            <p class="mt-3 fs-3">
                                                Dengan melakukan pendaftaran, saya setuju dengan Kebijakan Privasi dan Syarat & Ketentuan Iprahumas.
                                            </p>
