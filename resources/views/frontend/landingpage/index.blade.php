...
@section('contents')
    <div class="main-wrapper overflow-hidden">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="card shadow-none border-2 rounded-24">
                            <div class="card-body text-center py-14">
                                ...
                                <h5 class="my-3 fw-bolder fs-5">Tangkal Hoax</h5>
        ...
        <!-- List Start -->
        <!-- ------------------------------------- -->
        <section class="pt-2 pt-md-10 pt-lg-8 pb-4 pb-md-5 pb-lg-14">
            <div class="container-fluid">
                ...
                <div class="ml-3 text-center mb-5">
                    <button class="btn btn-danger px-9 py-6">Lihat Lebih Banyak</button>
                </div>
            </div>
        </section>
        <!-- ------------------------------------- -->
        ...
        <section>
            <div class="custom-container">
                <div class="py-5 py-md-14 py-lg-12 bg-danger-subtle rounded-3 overflow-hidden">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
